...
public class City
{
	...
	public void average_capacity()
	{
		...
		if (cinema_count != 0)
		{
			Console.WriteLine("\n" + "Cередня ємність кінотеатрів: " + cinema_sum / cinema_count);
		}
		if (public_count != 0)
		{
			Console.WriteLine("\n" + "Cередня ємність громадських будівель: " + public_sum / public_count);
		}
		if (residental_count != 0)
		{
			Console.WriteLine("\n" + "Cередня ємність всіх житлових будівель: " + residental_sum / residental_count);
		}
		if (hotel_count != 0)
		{
			Console.WriteLine("\n" + "Cередня ємність всіх готелів: " + hotel_sum / hotel_count);
		}
	}
}